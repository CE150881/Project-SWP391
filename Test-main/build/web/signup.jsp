...
<html style="font-size: 16px;" lang="vi-VN">
    ...
    <body class="u-body"><header class="u-align-center-xs u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-e122"><div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-custom-menu u-nav-container" style="margin-top: -50px; margin-left: -90px">
                    <ul class="u-custom-font u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class=" u-nav-link u-text-active-black" href="home" style="padding: 5px 75px;">TRANG CHỦ</a>
                ...
                <div class="u-form u-form-1">
                    <form action="signup" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;" source="custom" name="form">
                        <div class="u-form-group u-form-group-1">
                            ...
                            <input type="text" value="${user}" placeholder="Nhập tên đăng nhập" id="text-9294" name="user" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" pattern="[A-Za-z0-9]{5,20}" title="Nhập 5 đến 20 kí tự bao gồm chữ cái và số." required="required"><p class="text-danger"> ${error1}</p>
                        </div>
                        <div class="u-form-group u-form-group-2">
                            <label for="text-18e9" class="u-custom-font u-label u-label-2">Mật khẩu </label>
                            <input type="password" placeholder="Xác nhận mật khẩu" id="text-18e9" value="${pass}" name="pass" title="Mật khẩu không hợp lệ." class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" maxlength="20" minlength="8" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();" required="required" title="Nhập 8 đến 20 kí tự."><p class="text-danger"> ${error5}</p>
                        </div>
                        <div class="u-form-group u-form-group-3">
                            <label for="text-d755" class="u-custom-font u-label u-label-3">Xác nhận mật khẩu </label>
                            <input type="password" id="text-d755" name="repass" value="${re_pass}" title="Xác nhận mật khẩu không hợp lệ." class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" maxlength="16" minlength="8" placeholder="Xác nhận mật khẩu mới" onmouseover="mouseoverPass2();" onmouseout="mouseoutPass2();" required="required"><p class="text-danger"> ${error5}</p>
                        </div>

                        <div class="u-form-group u-form-phone">
                            <label for="email-158d" class="u-custom-font u-label u-label-5">Số điện thoại</label>
                            <input type="tel" pattern="[0][0-9]{9}" value="${phone}" id="phone11" name="phone" title="Số điện thoại không hợp lệ." class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white"  required="required" maxlength="10" placeholder="Nhập số điện thoại" title="Nhập 10 kí tự chỉ bao gồm số."><p class="text-danger"> ${error2}</p>
                        </div>
                        <div class="u-form-email u-form-group u-form-group-4">
                            ...
                            <input type="email" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" placeholder="Email"id="address-f3ab" value="${mail}" name="mail" title="Email không hợp lệ." class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" required="required"><p class="text-danger"> ${error3}</p>
                        </div>

            ...
            <div class="row-fluid">
                ...
                <div id="content" class="span10">
                    ...
                    <div>
                        ...
                        <a href="add" class="btn btn-primary">Thêm Món Ăn</a>
                    </div>
                    <br>
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon white user"></i><span class="break"></span>Món Ăn</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                        <%
                                            ResultSet rs = (ResultSet) session.getAttribute("allFood");
                                            while (rs.next()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img height="150px" width="200px" src="../upload/<%= image%>"></td>
                                            <td><%= rs.getString("categoryName")%></td>
                                            <td class="center">
                                                <a class="btn btn-info" href="edit/<%= rs.getString("foodID")%>">
                                                    <i class="halflings-icon white edit"></i>  
                                                </a>

                                                <a class="btn btn-danger" href="delete/<%= rs.getString("foodID")%>" onclick="return confirm('Bạn chắc chắn chưa?');">

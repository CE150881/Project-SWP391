...
<html style="font-size: 16px;" lang="vi-VN">
    ...
    <body <c:if test="${not empty requestScope.FALIEDRENEWPASS}">
        ...
        <section class=" u-clearfix u-palette-3-light-3 u-section-1" id="sec-1826" style="padding-top: 50px; padding-bottom: 30px; padding-left: 20px">
            ...
            <form action="updatePass" method="POST" style="width: 800px; font-family: Alata; font-size: 1.5rem; margin: -230px 0 50px 600px">            
